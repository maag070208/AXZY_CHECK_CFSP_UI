    ...
    <div className="p-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 mb-6">
        ...
        <div className="flex items-center gap-2 pt-6">
          ...
          <label
            htmlFor="active"
            className="text-sm font-bold text-slate-700 cursor-pointer uppercase tracking-wider text-[10px]"
          >
            Cliente Activo
          </label>
        </div>
      ...
      <div className="flex justify-end gap-3 mt-8">
        ...
        <ITButton
          className="bg-emerald-600 text-white border-emerald-600 hover:bg-emerald-700 !rounded-xl px-8 shadow-lg shadow-emerald-100"
